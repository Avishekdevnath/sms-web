...
export default function GuidelinePostDetailPage() {
  const params = useParams();
  const postId = String(params?.postId || "");

  const [post, setPost] = useState<any>({
    _id: postId,
    title: "Demo post: How to structure mission guidelines",
    body: demoBody,
    status: "pending",
...
function CommentFeed({ comments, onReply }: { comments: any[]; onReply: (id: string) => void }) {
  // Discord-like flat feed with reply context: same indent, with a quoted line linking to parent
...
const demoBody = `This is a static demo post with code and images.
