...
export default function AdminResourcesPage() {
  ...
  const [resources, setResources] = useState<Resource[]>([
    { _id: "ar1", title: "Mentor Handbook", content: "This handbook covers mentorship expectations, meeting cadence, and feedback loops.", tags: ["mentor", "policy"], createdAt: "2025-01-01T10:00:00.000Z" },
    { _id: "ar2", title: "Admin SOP", content: "Standard operating procedures for admins: onboarding, permissions, and audit logs.", tags: ["admin", "process"], createdAt: "2025-01-02T12:00:00.000Z" },
    { _id: "ar3", title: "Cloudinary Image Guide", content: "How to upload images to Cloudinary and reference URLs in posts.", tags: ["upload", "media"], createdAt: "2025-01-03T14:30:00.000Z" },
  ]);
  ...
  const onCreate = (e: React.FormEvent) => {
    ...
    const tagsArr = newTags.split(",").map(s => s.trim()).filter(Boolean);
    const created: Resource = { _id: id, title: newTitle || "Untitled", content: newContent || "Sample resource content.", tags: tagsArr, createdAt: new Date().toISOString() };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold">Admin Groups • Resources</h2>
